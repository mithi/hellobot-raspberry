...
class Motors{
  ...
  public:
    ...
    void MinToMax(int min, int max, byte period, byte incr, bool dir);
    void MaxToMin(int max, int min, byte period, byte decr, bool dir);
    void MinToMaxRotate(int min, int max, byte period, byte incr, bool dir);
    void MaxToMinRotate(int max, int min, byte period, byte decr, bool dir);
  private:
    void _drive_helper(int speed, bool direction, byte period);
